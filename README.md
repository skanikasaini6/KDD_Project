...
6.	Now we have a single dataset with all the columns required for exploratory Data Analysis.<br/>
7.Checking for Null values and imputing with constants<br/>
